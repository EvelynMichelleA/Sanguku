...
--
-- Host: localhost    Database: Sanguku
-- ------------------------------------------------------
...
CREATE TABLE `detail_transaksi_penjualan` (
  ...
  `id_transaksi_penjualan` bigint unsigned NOT NULL,
  ...
  KEY `detail_transaksi_penjualan_id_transaksi_penjualan_foreign` (`id_transaksi_penjualan`),
  KEY `detail_transaksi_penjualan_id_menu_foreign` (`id_menu`),
  CONSTRAINT `detail_transaksi_penjualan_id_menu_foreign` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id_menu`) ON DELETE CASCADE,
  CONSTRAINT `detail_transaksi_penjualan_id_transaksi_penjualan_foreign` FOREIGN KEY (`id_transaksi_penjualan`) REFERENCES `transaksi_penjualan` (`id_transaksi_penjualan`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `menu` (
  ...
  `gambar_menu` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `migrations` VALUES (1,'0001_01_00_000003_create_role_table',1),(2,'0001_01_00_000004_create_users_table',1),(3,'0001_01_01_000000_create_menu_table',1),(4,'0001_01_01_000000_create_pelanggan_table',1),(5,'0001_01_01_000000_create_pengeluaran_table',1),(6,'0001_01_01_000000_create_transaksi_penjualan_table',1),(7,'0001_01_01_000001_create_cache_table',1),(8,'0001_01_01_000002_create_jobs_table copy',1);
...
CREATE TABLE `pengeluaran` (
  ...
  `keterangan_pengeluaran` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_pengeluaran`),
  KEY `pengeluaran_id_foreign` (`id`),
  CONSTRAINT `pengeluaran_id_foreign` FOREIGN KEY (`id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transaksi_penjualan` (
  `id_transaksi_penjualan` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `transaksi_penjualan_id_user_foreign` (`id_user`),
  CONSTRAINT `transaksi_penjualan_id_pelanggan_foreign` FOREIGN KEY (`id_pelanggan`) REFERENCES `pelanggan` (`id_pelanggan`) ON DELETE SET NULL,
  CONSTRAINT `transaksi_penjualan_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-12-05 14:49:27
