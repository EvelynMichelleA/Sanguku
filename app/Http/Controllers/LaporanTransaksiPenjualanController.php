    ...
    public function exportPDF()
{
    ...
    $pdf = Pdf::loadView('laporan_transaksi_penjualan.pdf', [
        'transaksi' => $transaksi,
        'pelanggan' => $pelanggan,
        'start_date' => $tanggalDari ? \Carbon\Carbon::parse($tanggalDari)->format('d-m-Y') : null,
        'end_date' => $tanggalSampai ? \Carbon\Carbon::parse($tanggalSampai)->format('d-m-Y') : null,
    ]);
