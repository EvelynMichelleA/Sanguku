...
<div style="padding: 20px; background-color: #DEEFFE; min-height: 100vh;">
    <div style="max-width: 1500px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; padding: 20px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
        <h2 style="font-size: 24px; font-weight: bold; color: #1e3a8a; margin-bottom: 20px; text-align: center;">Pelanggan &gt;&gt; Tampil Detail Pelanggan</h2>
        ...
        <div style="margin-top: 20px; display: flex; justify-content: center;">
            <a href="{{ route('pelanggan.index') }}" style="padding: 10px 20px; background-color: #3b82f6; color: white; text-decoration: none; border-radius: 5px; font-size: 14px; text-align: center;">Kembali</a>
        </div>
    </div>
</div>
@endsection
