...
@section('content')
<div class="container">
    <h3>Pelanggan >> Update Pelanggan</h3>
    <form action="{{ route('pelanggan.update', $pelanggan->id_pelanggan) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="email" name="email_pelanggan" id="email_pelanggan" class="form-control" value="{{ old('email_pelanggan', $pelanggan->email_pelanggan) }}" required>
