...
@section('content')
                            ...
                            <select id="id_pelanggan" name="id_pelanggan" class="form-control"
                                ...
                                @foreach ($pelanggan as $customer)
                                    <option value="{{ $customer->id_pelanggan }}"
                                        data-poin="{{ $customer->jumlah_poin }}">
                                        {{ $customer->nomor_telepon }} - {{ $customer->nama_pelanggan }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <!-- Hidden fields to pass subtotal and diskon -->
    ...
    // Hidden fields for subtotal and diskon
    ...
    gunakanPoinCheckbox.addEventListener('change', () => {
        ...
        // Update the hidden diskon and subtotal fields
