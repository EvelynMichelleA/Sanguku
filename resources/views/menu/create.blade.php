    ...
    <div style="padding: 20px; background-color: #DEEFFE; min-height: 100vh;">
        <div
            ...
            <form action="{{ route('menu.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="file" id="gambar_menu" name="gambar_menu" accept="image/*" onchange="previewImage(event)" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 14px;">
                @error('gambar_menu')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
